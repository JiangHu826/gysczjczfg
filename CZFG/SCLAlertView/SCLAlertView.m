...
+ (void)showErrorMessage:(NSString *)message viewController:(UIViewController *)vc retryBlock:(SCLActionBlock)block
{
    SCLAlertView *alert = [[SCLAlertView alloc] init];
    [alert addButton:@"重试" actionBlock:block];
    [alert showNotice:vc title:nil subTitle:message closeButtonTitle:@"放弃" duration:0.0];
}
